    ...
    <div className="h-full flex flex-col items-center justify-center">
      <main className="max-w-80 space-y-6 animate-slideInLeft">
        <div className="space-y-1 text-center">
          ...
          <p className="text-md lg:text-lg text-stone-400">Crie sua conta para começar a explorar o mundo dos pets</p>
        </div>
        <form className="space-y-6" onSubmit={handleSubmit(handleRegisterUser)}>
          <div className="space-y-3">
            <Input placeholder="Digite seu nome..." {...register("name")} />
            <Input placeholder="Digite seu nome de usuário..." {...register("username")} />
